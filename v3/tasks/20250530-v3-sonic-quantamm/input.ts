...
export async function createPoolParams(
  ...
  const parameters = [
    ...
    [bn('11037321655782598'), bn('72324601375887462'), bn('2762835127905918'), bn('74853775497883593')], //amplitude
  ...
  //[bn('0.074853775497883593'), bn('0.0027628351279059180'), bn('0.011037321655782598'), bn('0.072324601375887462')], //amplitude
